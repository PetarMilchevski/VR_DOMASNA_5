...
public class Player : MonoBehaviour
{
    ...
    public float lookDownAngle = 15.0f;         // Create a variable to represent the look down angle that will trigger the players movement
    public float speed = 1.0f;                  // Create a variable to represent the speed the player will move
